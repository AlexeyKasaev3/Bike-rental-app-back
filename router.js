...
router.post("/rent_bicycle/:bicycleId", (req, res) => rentController.rentBicycle(req, res));
router.post("/rent_bicycle_cancel/:bicycleId", (req, res) => rentController.rentBicycleCancel(req, res));
